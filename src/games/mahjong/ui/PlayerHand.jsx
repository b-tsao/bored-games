...
export function PlayerHand(props) {
  ...
  //     let temp = [];
  //     for (let i = 0; i < num; i++) {
  //       temp.push(<Tile suit="flower" value={(i % 4) + 1} />);
  //     }
  //     return temp;
  //   }
  ...
  //     let temp = [];
  //     for (let i = 0; i < num; i++) {
  //       for (let j = 1; j <= 3; j++) temp.push(<Tile suit="character" value={j} />);
  //     }
  //     return temp;
  //   }
  ...
  //     let temp = [];
  //     for (let i = 0; i < num; i++) {
  //       temp.push(<Tile suit="character" value={(i % 9) + 1} large={true} />);
  //     }
  //     return temp;
  //   }

  //   setBonus(createBonus(4));
  //   setConcealed(createKong(1));
  //   setRevealed(createSet(3));
  //   setHand(createHand(14));
  // }, []);

  const claimBtn = (
    <Button variant="contained" color="primary" key="claim" onClick={() => claimTile()}>
      Claim
    </Button>
  );
  const discardBtn = (
  ...
  const readyBtn = (
    <Button variant="contained" color="primary" key="ready" onClick={() => skipTile()}>
      Ready
    </Button>
  );
